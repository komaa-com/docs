...
```
Point your StandIn identity's agent WebSocket URL at ws://<this-host>:9442/voice/msteams/stream
```
...
<Tabs>
  <Tab title="Tailscale Funnel">
    ...
    ```
    Your URL: `wss://<machine>.<tailnet>.ts.net/voice/msteams/stream`
  </Tab>
...
1. In your [StandIn dashboard](https://standin.komaa.com/dashboard), set the identity's
   **Agent calling URL** to the `wss://` URL from step 4.
