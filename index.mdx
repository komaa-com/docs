...
keywords: ["Microsoft Teams AI bot","Teams voice agent","Teams video bot","conversational video interface","CVI","AI avatar","OpenClaw","Hermes Agent","ElevenLabs agent Teams","LiveKit agent Teams","OpenAI Realtime Teams","StandIn"]
---
...
It ships as **five backends** - two plugins that drop into an agent framework you already run, and
three standalone bridges that connect a hosted, room-based, or speech-to-speech agent platform.
