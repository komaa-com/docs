...
It ships as **six backends** - two plugins that drop into an agent framework you already run, and
four standalone bridges that connect a hosted, room-based, or speech-to-speech agent platform.
