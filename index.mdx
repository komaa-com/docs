...
<CardGroup cols={2}>
  <Card title="OpenClaw plugin" icon="npm" href="/openclaw/installation">
    [`@komaa/msteams-voice`](https://www.npmjs.com/package/@komaa/msteams-voice) - TypeScript plugin for **OpenClaw**, via `openclaw plugins install`.
  </Card>
  <Card title="Hermes plugin" icon="python" href="/hermes/installation">
    [`hermes-plugin-teams-voice`](https://pypi.org/project/hermes-plugin-teams-voice/) - Python plugin for **Hermes Agent**, via `pip` / `uv`.
  </Card>
</CardGroup>
