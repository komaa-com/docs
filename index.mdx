...
<CardGroup cols={2}>
  ...
  <Card title="ElevenLabs bridge" icon="waveform-lines" href="/elevenlabs/installation">
    Put a hosted **ElevenLabs agent** on Teams calls - **voice only**, no chat lane. Node
  ...
  <Card title="LiveKit bridge" icon="tower-broadcast" href="/livekit/installation">
    Dispatch any **LiveKit agent** (incl. avatar agents) into Teams calls - **voice only**, no chat
    lane. Node
