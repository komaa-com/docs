...
keywords: ["Microsoft Teams AI bot","Teams voice agent","Teams video bot","conversational video interface","CVI","AI avatar","OpenClaw","Hermes Agent","ElevenLabs agent Teams","LiveKit agent Teams","OpenAI Realtime Teams","Deepgram Voice Agent Teams","StandIn"]
---
