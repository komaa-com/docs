...
It ships as **four backends** - two plugins that drop into an agent framework you already run, and
two standalone bridges that connect a hosted or room-based agent platform. Pick the one that matches
your stack:
