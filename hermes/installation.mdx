...
<Note>
  ...
  the same machine? Keep Hermes voice on 8443 and put OpenClaw on the remaining slot:
  `tailscale funnel --bg --https=10000 9442` → `wss://<machine>.<tailnet>.ts.net:10000/voice/msteams/stream`.
