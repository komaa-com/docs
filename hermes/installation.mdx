...
The bridge binds its media WebSocket (default `ws://<host>:8443/msteams/calling`).
...
<Note>
  ...
  **OpenClaw voice on 8443 -> 9442** and move **Hermes voice to the 10000 slot**:
  `tailscale funnel --bg --https=10000 8443` → `wss://<machine>.<tailnet>.ts.net:10000/msteams/calling`.
