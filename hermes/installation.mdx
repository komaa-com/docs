...
keywords: ["hermes-msteams-bridge","Hermes Agent plugin","pip install Teams voice","teams_voice","uv pip"]
---

[`hermes-msteams-bridge`](https://pypi.org/project/hermes-msteams-bridge/) (plugin name **`teams_voice`**) is the Python half of the Teams CVI for
