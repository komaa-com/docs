---
title: "Configuration"
description: "Configure teams_call via config.yaml + .env, pick a realtime backend, and run the bridge."
keywords: ["Hermes teams_call config","config.yaml env","Azure OpenAI realtime","Microsoft Graph permissions","allow_remote_worker"]
---
