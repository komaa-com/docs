...
| `openclaw/installation.mdx`, `openclaw/configuration.mdx` | OpenClaw plugin (npm `@komaa/openclaw-msteams-bridge`, ClawHub `@komaa/msteams-bridge`; plugin id `msteams-bridge`) |
