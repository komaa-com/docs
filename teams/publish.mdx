...
In your StandIn dashboard, register your **Agent calling URL** and the matching HMAC `sharedSecret`
...
- Bot joins but stays silent → usually a `sharedSecret` mismatch or an unreachable Agent calling URL;
