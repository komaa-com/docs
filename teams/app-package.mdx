---
title: "Get the Teams app package"
description: "Download the generated Teams app package (manifest zip) from StandIn, or build it yourself from the example manifest."
keywords: ["Teams app manifest example","Teams app package zip","manifest.json","Teams Developer Portal","validDomains","supportsCalling"]
---

Part 2 of the [Teams setup](/teams/overview). The app package is what makes your bot appear (and be
callable) in Teams: a zip with a `manifest.json` and two icons. All four bridges use the **same
