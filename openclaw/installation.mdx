...
keywords: ["@komaa/openclaw-msteams-bridge","OpenClaw plugin install","openclaw plugins install","npm Teams bridge plugin"]
---
...
<Note>
  ClawHub listing pending; install from npm above. OpenClaw falls back to npm
