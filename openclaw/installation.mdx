---
title: "Installation"
description: "Install @komaa/msteams-bridge into an OpenClaw host."
keywords: ["@komaa/msteams-bridge","OpenClaw plugin install","openclaw plugins install","npm Teams voice plugin"]
---

[`@komaa/msteams-bridge`](https://www.npmjs.com/package/@komaa/msteams-bridge) is a self-contained Teams CVI plugin for **OpenClaw**. It depends only on the
...
<Note>
  Also on ClawHub: `openclaw plugins install clawhub:@komaa/msteams-bridge` - OpenClaw falls back to npm
...
<CardGroup cols={3}>
  ...
  <Card title="npm" icon="npm" href="https://www.npmjs.com/package/@komaa/msteams-bridge" />
