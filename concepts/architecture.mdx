...
The **plugin is the WebSocket server** (default calling port `:9442` on OpenClaw, `:8443` on Hermes,
`:8080` on the LiveKit and ElevenLabs bridges); the **hosted StandIn bridge is the client** that
