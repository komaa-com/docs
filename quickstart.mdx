...
<Tabs>
  <Tab title="macOS / Linux">
    ...
    ```bash
    echo "12ce9e2bbddb621efa7df49311d8addce301bc03d1dbc6e92ce9c237a9a4a501  install.sh" | sha256sum -c -
    ```
  ...
  <Tab title="Windows (PowerShell)">
    ...
    ```powershell
    (Get-FileHash install.ps1).Hash -eq "5B2A3DF29C38A3BA9501341D38CECF8FEA37407929672900CB2E930F5C2E98AB"
    ```
