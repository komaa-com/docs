...
<Tabs>
  <Tab title="macOS / Linux">
    ...
    echo "e2a3950df9182f1019af79171751fcab33712e41e69469c9e63ae360c4ca3daa  install.sh" | sha256sum -c -   # macOS: shasum -a 256 -c -
    bash install.sh
    ```
  </Tab>
  <Tab title="Windows (PowerShell)">
    ...
    (Get-FileHash install.ps1).Hash -eq "3126129CF90BB42B4B320724A4A5FACB1E1D976AA87640FE78B3B4AF6306200A"   # must print True
    ./install.ps1
    ```
  </Tab>
</Tabs>
