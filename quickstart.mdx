...
**free identity** (your own Azure bot, capped at 5 minutes/day, one per account), or the **sandbox**
...
- **You run the official `msteams` channel plugin** (so you already have an Azure Bot App ID + secret;
  ...
  as paid - your own bot, your own tenant, inbound calls to your own Teams identity - capped at
  **5 minutes of call time per day**, one free identity per account, held alongside any paid identities.
