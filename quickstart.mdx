...
<Tabs>
  <Tab title="macOS / Linux">
    ...
    ```bash
    echo "9a38cdf251fd9f6de188a7d7dc7ee26153a1d343da77ec91bec48f7eddc22316  install.sh" | sha256sum -c -
    ```
  ...
  <Tab title="Windows (PowerShell)">
    ...
    ```powershell
    (Get-FileHash install.ps1).Hash -eq "ADA60C038F82942A04E474F3D42551F85781860203CB916BA4F9CFA7A41B0DE9"
    ```
