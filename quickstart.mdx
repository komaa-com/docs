...
echo "a997a40ee753253adfc988f03376c70016bc3ffa3256265209237910dddcd5ba  install.sh" | sha256sum -c -   # macOS: shasum -a 256 -c -
bash install.sh
```

On Windows, download with `irm https://standin.komaa.com/install.ps1 -OutFile install.ps1`, then `Get-FileHash install.ps1`
should equal `005336218AF00E64CB1057A1522A09DF4B1224E54402DF029EBB43B7041F666F`. Checksums are for the current release and
