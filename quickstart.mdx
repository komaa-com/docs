...
echo "17b9a5b936a14a5953b8400378368123b447f3f22fc2a2efb3de8ad2d8f444d3  install.sh" | sha256sum -c -   # macOS: shasum -a 256 -c -
bash install.sh
```

On Windows, download with `irm https://standin.komaa.com/install.ps1 -OutFile install.ps1`, then `Get-FileHash install.ps1`
should equal `7C1BFC1479BE41F0F00069AE27E953DBB9BA3E8146EC2548CB386128D5D8A870`. Checksums are for the current release and
