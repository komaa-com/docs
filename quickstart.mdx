  ...
  <Tab title="OpenClaw (npm)">
    <Steps>
      ...
      <Step title="Run + call">
        ...
        **Agent voice URL** (`wss://<your-public-host>:8443/msteams/calling` via the funnel; local bind `ws://<host>:9442/...`) and the matching secret. Place a Teams call to your bot.
      </Step>
    </Steps>
  </Tab>
  <Tab title="Hermes (pip)">
    <Steps>
      ...
      <Step title="Run + call">
        ...
        ```
        In your StandIn dashboard, register your **Agent voice URL** (`wss://<your-public-host>:8443/msteams/calling` via the funnel; local bind `ws://<host>:8443/...`)
