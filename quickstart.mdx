...
<Note>
**First chat message ignored?** OpenClaw's chat channel drops DMs from unapproved senders by default
(`dmPolicy: pairing`). Approve yourself once with `openclaw pairing approve msteams <CODE>` - see
