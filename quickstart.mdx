...
<Tabs>
  <Tab title="macOS / Linux">
    ...
    ```bash
    echo "e2a3950df9182f1019af79171751fcab33712e41e69469c9e63ae360c4ca3daa  install.sh" | sha256sum -c -
    ```
  ...
  <Tab title="Windows (PowerShell)">
    ...
    ```powershell
    (Get-FileHash install.ps1).Hash -eq "3126129CF90BB42B4B320724A4A5FACB1E1D976AA87640FE78B3B4AF6306200A"
    ```
